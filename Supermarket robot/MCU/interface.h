...
//ok cx垃圾准备写第一个改变函数：希望能再多出两个超声波，基本是找到上述的名字且替换

//超声波控制 外部中断返回 PE0
#define Echo_PINA         GPIO_Pin_0
#define Echo_GPIOA        GPIOE
#define Echo_PORTSOURCEA  GPIO_PortSourceGPIOE
#define Echo_PINSOURCEA   GPIO_PinSource0
#define Echo_EXITLINEA    EXTI_Line0
#define Echo_IRQCH        EXTI15_10_IRQn
#define EchoA             GPIO_ReadInputDataBit(Echo_GPIOA, Echo_PINA)
//触发IO PE2
#define Trig_PINA         GPIO_Pin_2
#define Trig_GPIOA        GPIOE
#define Trig_RESETA       GPIO_SetBits(Trig_GPIOA , Trig_PINA)
#define Trig_SETA         GPIO_ResetBits(Trig_GPIOA , Trig_PINA)
...
//超声波控制 外部中断返回 PE0
#define Echo_PINB         GPIO_Pin_4
#define Echo_GPIOB        GPIOE
#define Echo_PORTSOURCEB  GPIO_PortSourceGPIOE
#define Echo_PINSOURCEB   GPIO_PinSource4
#define Echo_EXITLINEB    EXTI_Line4
#define Echo_IRQCH        EXTI15_10_IRQn
#define EchoB             GPIO_ReadInputDataBit(Echo_GPIOB, Echo_PINB)
//触发IO PE2
#define Trig_PINB         GPIO_Pin_6
#define Trig_GPIOB        GPIOE
#define Trig_RESETB       GPIO_SetBits(Trig_GPIOB , Trig_PINB)
#define Trig_SETB         GPIO_ResetBits(Trig_GPIOB , Trig_PINB)
